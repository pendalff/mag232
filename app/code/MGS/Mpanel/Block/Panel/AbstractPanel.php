...
abstract class AbstractPanel extends Template
{
	...
	public function __construct(
		...
		if($this->_fullActionName == 'cms_index_index'){
			$pageIdentifier = $this->_helper->getStoreConfig('web/default/cms_home_page');
			$page = $this->getModel('Magento\Cms\Model\Page')->setStoreId($this->_storeManager->getStore()->getId())->load($pageIdentifier);
