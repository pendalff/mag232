...
class Toppanel extends Template
{
	...
	public function getCmsPageId(){
		if($this->getRequest()->getFullActionName()=='cms_index_index'){
			$pageIdentifier = $this->helper->getStoreConfig('web/default/cms_home_page');
			$page = $this->getModel('Magento\Cms\Model\Page')->setStoreId($this->getStoreId())->load($pageIdentifier);
			return $page->getId();
		}else{
